...
// const client = new MongoClient(Config.config.connectionString)
...
class LoggerRepository {
  ...
  const collection = db.collection('bi_aa_bmultidimensionals');
  ...
  return collection.find({}).toArray();
    ...
    // Connection URL
    // const url = 'mongodb://localhost:27017/?readPreference=primary&appname=MongoDB%20Compass&directConnection=true&ssl=false'; // Replace with your MongoDB server URL
    ...
    // const client = new MongoClient('mongodb://localhost/piips',);
    // await client.connect()
    ...
    // await client.connect()
    // const db = client.db()
    // const usersCollection = db.collection('logs')
