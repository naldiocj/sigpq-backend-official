...
export default class extends BaseSeeder {
  public async run() {
    const ids: number[] = [104, 105, 107, 108, 109, 110, 112];
    ...
    try {
      ...
      if (funcionarios.length === 0) {
        console.log("Nenhum funcionário encontrado com os ids 104, 105, 107, 108, 109, 110 e 112.");
        await trx.rollback();
        return;
      }
      ...
      await trx.commit();
      console.log(
        "Funcionários 104, 105, 107, 108, 109, 110 e 112 removidos com sucesso."
      );
    } catch (error) {
      await trx.rollback();
